...
export function UpdateView(props) {
  ...
  const handleSubmit = (e) => {
    ...
    if (isReq) {
      ...
      axios.put(`https://brett-flix.herokuapp.com/users/${user.Username}`, {
        Username: username,
        Password: password,
        Email: email,
        Birthday: birthday
          ...
          <Form>
            <Form.Group controlId="formUsername">
              ...
              <Form.Group controlId="formEmail">
                ...
                <Form.Control type="text" value={email} onChange={e => setEmail(e.target.value)} placeholder="youremail@email.com" required />
                {/* display validation error */}
